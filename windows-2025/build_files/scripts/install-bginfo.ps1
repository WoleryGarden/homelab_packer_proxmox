...
Invoke-WithRetry "Downloading BgInfo" {
...
Copy-Item  "D:\BTServer.bgi" "C:\Program Files\BGInfo\BTServer.bgi"
...
cmd /c $Command
"Done installing BgInfo. Exit code: $LASTEXITCODE" | Write-Host
